   ...
   // const [counter, setCounter] = useState(0);
    ...
    return (
        <div>
          ...
          <div>
           <img  src="https://nypost.com/wp-content/uploads/sites/2/2014/11/interstellar1a.jpg?quality=75&strip=all" style={{width: 150, height: 150}}/>
            <br />
            <button onClick={()=>{setMovie1Votes(movie1Votes + 1);}}>
                Vote
            </button>
